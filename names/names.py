...
# The runtime complexity using sets is O(m + n), where m is the number of elements in the first list (names_1) and n is the number of elements in the second list (names_2). This would result in linear time complexity.
